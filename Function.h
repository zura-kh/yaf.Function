...
// ReturnType (A1, A2)
// ...
#define YAF_SIGNATURE_SPEC_0 ReturnType (YAF_FUNCTION_ARG_TYPE_LIST_0)
#define YAF_SIGNATURE_SPEC_1 ReturnType (YAF_FUNCTION_ARG_TYPE_LIST_1)
#define YAF_SIGNATURE_SPEC_2 ReturnType (YAF_FUNCTION_ARG_TYPE_LIST_2)
#define YAF_SIGNATURE_SPEC_3 ReturnType (YAF_FUNCTION_ARG_TYPE_LIST_3)
#define YAF_SIGNATURE_SPEC_4 ReturnType (YAF_FUNCTION_ARG_TYPE_LIST_4)
#define YAF_SIGNATURE_SPEC_5 ReturnType (YAF_FUNCTION_ARG_TYPE_LIST_5)
#define YAF_SIGNATURE_SPEC_6 ReturnType (YAF_FUNCTION_ARG_TYPE_LIST_6)
#define YAF_SIGNATURE_SPEC_7 ReturnType (YAF_FUNCTION_ARG_TYPE_LIST_7)

// NOTE: this variant produces compile errors in gcc and clang when YAF_ARG_COUNT > 1
